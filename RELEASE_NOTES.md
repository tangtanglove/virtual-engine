...
**Files Changed:**
- `app/src/main/java/com/chiyuan/va/app/view/main/BlackBoxLoader.kt`
- `app/src/main/java/com/chiyuan/va/app/view/setting/SettingFragment.kt`
- `app/src/main/res/xml/setting.xml`
- `app/src/main/res/values/strings.xml`
- `Bcore/src/main/java/com/chiyuan/va/app/configuration/ClientConfiguration.java`
- `Bcore/src/main/java/com/chiyuan/va/BlackBoxCore.java`
...
**Files Changed:**
- `app/src/main/java/com/chiyuan/va/app/view/main/MainActivity.kt`
...
**Files Changed:**
- `Bcore/src/main/java/com/chiyuan/va/fake/service/context/providers/SystemProviderStub.java`
- `Bcore/src/main/java/com/chiyuan/va/fake/hook/ClassInvocationStub.java`
...
```
OppoThermalStats: PackageManager$NameNotFoundException: com.chiyuan.va.app:p0
```
