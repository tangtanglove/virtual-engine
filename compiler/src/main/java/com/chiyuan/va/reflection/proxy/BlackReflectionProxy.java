...
import com.chiyuan.va.reflection.BlackReflectionInfo;
import com.chiyuan.va.reflection.utils.ClassUtils;


public class BlackReflectionProxy {

    private static final ClassName BR = ClassName.get("com.chiyuan.va.reflection", "BlackReflection");
    ...
    private MethodSpec generaIsLoadMethod() {
        ...
        String statement = "return com.chiyuan.va.reflection.utils.ClassUtil.classReady($T.class)";
        builder.addStatement(statement,
                mContextInterface
        );
        return builder.build();
