        ...
        try {
            ...
            for (String fieldName : uidFieldNames) {
                try {
                    ...
                    uidField.set(attributionSource, ChiyuanVACore.getHostUid());
            ...
            for (String fieldName : packageFieldNames) {
                try {
                    ...
                    packageField.set(attributionSource, ChiyuanVACore.getHostPkg());
    ...
    public static Object createSafeAttributionSource() {
        try {
            ...
            try {
                ...
                attributionSource = constructor.newInstance(ChiyuanVACore.getHostUid(), ChiyuanVACore.getHostPkg());
            } catch (Exception e) {
                try {
