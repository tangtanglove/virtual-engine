package com.chiyuan.va.utils.provider;
...
import com.chiyuan.va.utils.compat.ContentProviderCompat;


public class ProviderCall {
    public static Bundle callSafely(String authority, String methodName, String arg, Bundle bundle) {
        try {
            return call(authority, ChiyuanVACore.getContext(), methodName, arg, bundle, 5);
