            ...
            Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
                ...
                public void uncaughtException(Thread thread, Throwable throwable) {
                    ...
                    if (isNullContextCrash(throwable)) {
                        ...
                        ChiyuanVACore.get().sendLogs("CRASH DETECTED (Caught/NullContext): " + throwable.getMessage(), true);
                        return; 
                    }
                    ...
                    if (isGooglePlayServicesCrash(throwable)) {
                        ...
                        ChiyuanVACore.get().sendLogs("CRASH DETECTED (Caught/GMS): " + throwable.getMessage(), true);
                        return; 
                    }
                    ...
                    if (isWebViewCrash(throwable)) {
                        ...
                        ChiyuanVACore.get().sendLogs("CRASH DETECTED (Caught/WebView): " + throwable.getMessage(), true);
                        return; 
                    }
                    ...
                    if (isAttributionSourceCrash(throwable)) {
                        ...
                        ChiyuanVACore.get().sendLogs("CRASH DETECTED (Caught/Attribution): " + throwable.getMessage(), true);
                        return; 
                    }
                    ...
                    if (isSocialMediaAppCrash(throwable)) {
                        ...
                        ChiyuanVACore.get().sendLogs("CRASH DETECTED (Caught/SocialMedia): " + throwable.getMessage(), true);
                        return; 
                    }
                    ...
                    try {
                         ChiyuanVACore.get().sendLogs("FATAL CRASH (Uncaught): " + throwable.getMessage(), false);
                    } catch (Throwable e) {
