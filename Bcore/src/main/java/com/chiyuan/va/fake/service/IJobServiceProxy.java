...
import com.chiyuan.va.utils.UIDSpoofingHelper;
...
public class IJobServiceProxy extends BinderInvocationStub {
    ...
    public static class Schedule extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                try {
                    JobInfo proxyJobInfo = ChiyuanVACore.getBJobManager().schedule(jobInfo);
                    ...
                    Slog.w(TAG, "Schedule: ChiyuanVA job manager failed, trying system fallback", e);
                }
    ...
    public static class Cancel extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                args[0] = ChiyuanVACore.getBJobManager()
    ...
    public static class CancelAll extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ChiyuanVACore.getBJobManager().cancelAll(BActivityThread.getAppConfig().processName);
                return method.invoke(who, args);
            } catch (Exception e) {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                try {
                    ...
                    Slog.w(TAG, "Enqueue: ChiyuanVA job manager failed, trying system fallback", e);
                }
