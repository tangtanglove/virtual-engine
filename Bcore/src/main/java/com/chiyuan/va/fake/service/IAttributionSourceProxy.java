    ...
    public static class AttributionSourceConstructor extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            try {
                ...
                int uid = ChiyuanVACore.getHostUid();
                String packageName = ChiyuanVACore.getHostPkg();
                ...
                return createSafeAttributionSource(ChiyuanVACore.getHostUid(), ChiyuanVACore.getHostPkg());
            }
        }
    ...
    public static class FromParcel extends MethodHook {
        ...
        private void fixAttributionSourceUid(Object attributionSource) {
            try {
                ...
                setUidMethod.invoke(attributionSource, ChiyuanVACore.getHostUid());
                
                Slog.d(TAG, "Fixed AttributionSource UID to: " + ChiyuanVACore.getHostUid());
            } catch (Exception e) {
