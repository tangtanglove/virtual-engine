...
import com.chiyuan.va.app.util.ContextUtil.openAppSystemSettings
import com.chiyuan.va.app.view.main.ShortcutActivity
...
object ShortcutUtil {
    ...
    private fun showAllowPermissionDialog(context: Context){
        if (!AppManager.mChiyuanVALoader.showShortcutPermissionDialog()){
            return
        }
        ...
        MaterialDialog(context).show {
            ...
            neutralButton(R.string.no_reminders){
                AppManager.mChiyuanVALoader.invalidShortcutPermissionDialog(false)
            }
        }
