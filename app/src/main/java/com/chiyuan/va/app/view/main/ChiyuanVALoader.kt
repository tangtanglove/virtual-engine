...
import com.chiyuan.va.app.app.rocker.RockerManager
import com.chiyuan.va.app.biz.cache.AppSharedPreferenceDelegate


class ChiyuanVALoader {
    ...
    fun getChiyuanVACore(): ChiyuanVACore {
        return try {
            ChiyuanVACore.get()
        } catch (e: Exception) {
                                    ...
                                    try {
                                        ...
                                        val intent =
                                                android.content.Intent(
                                                        "com.chiyuan.va.app.REQUEST_STORAGE_PERMISSION"
                                                )
    ...
    companion object {
        val TAG: String = ChiyuanVALoader::class.java.simpleName
    }
}
